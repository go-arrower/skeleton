...
func TestValidate(t *testing.T) {
	...
	t.Run("successful command", func(t *testing.T) {
		...
		cmd := application.Validate(validator.New(), exampleUseCaseEnsureValidated(t))
	...
	t.Run("failed command", func(t *testing.T) {
		...
		cmd := application.Validate(validator.New(), exampleUseCaseEnsureNotValidated(t))
	...
	t.Run("with default validator", func(t *testing.T) {
		...
		cmd := application.Validate(nil, exampleUseCaseEnsureValidated(t))
...
func TestValidateU(t *testing.T) {
	...
	t.Run("successful command", func(t *testing.T) {
		...
		cmd := application.ValidateU(validator.New(), exampleUseCaseUEnsureValidated(t))
	...
	t.Run("failed command", func(t *testing.T) {
		...
		cmd := application.ValidateU(validator.New(), exampleUseCaseUEnsureNotValidated(t))
	...
	t.Run("with default validator", func(t *testing.T) {
		...
		cmd := application.ValidateU(nil, exampleUseCaseUEnsureValidated(t))
...
func exampleUseCaseEnsureNotValidated(t *testing.T) func(context.Context, exampleRequest) (exampleResponse, error) {
	...
	return func(ctx context.Context, in exampleRequest) (exampleResponse, error) {
		assert.False(t, application.PassedValidation(ctx))
...
func exampleUseCaseEnsureValidated(t *testing.T) func(context.Context, exampleRequest) (exampleResponse, error) {
	...
	return func(ctx context.Context, in exampleRequest) (exampleResponse, error) {
		assert.True(t, application.PassedValidation(ctx))
